...
public class Golf_Prospector : MonoBehaviour
{

    static public Golf_Prospector S;
    ...
    public void CardClicked(Golf_CardProspector cd)
    {
        // The reaction is determined by the state of the clicked card
        switch (cd.state)
        {
            case Golf_eCardState.target:
                // Clicking the target card does nothing
                break;
            case Golf_eCardState.drawpile:
